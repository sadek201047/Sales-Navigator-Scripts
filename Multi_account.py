...
for i in range(0,10):
    ...
    Button = browser.find_element_by_xpath('//button[@class="save-to-list-dropdown__trigger__profile t-16"]')
    Button.click()
    time.sleep(0)
    ...
    browser.switch_to.window(browser.window_handles[0])
    Button2 = browser.find_element_by_xpath('//artdeco-dropdown-item[@class="a11y-artdeco-dropdown ember-view"]')
    Button2.click()
    time.sleep(.25)
